...
- Functions used for (block_t \*) are also used for (m_block_t \*) by casting
- pointers.
-
...
- Finds a mini or non-mini block. If no blocks in the seglist fit, searches
- the next seglist with larger sizes. If no seglists fit, returns NULL.
